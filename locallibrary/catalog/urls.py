...
urlpatterns += [
    ...
    re_path(r'^borrowersbooks/$', views.AllBorrowersListView.as_view(), name='all-borrowers'),
]
...
urlpatterns += [
    re_path(r'^books/create/$', views.BookCreate.as_view(), name='create_new_book'),
    re_path(r'^books/(?P<pk>\d+)/update/$', views.BookUpdate.as_view(), name='book_update'),
    re_path(r'^books/(?P<pk>\d+)/delete/$', views.BookDelete.as_view(), name='book_delete'),
